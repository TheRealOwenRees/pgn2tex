...
\newchessgame
\textbf{1.} \textbf{d4} \newline A88: Dutch Defence: Leningrad System: 5 Nf3 0-0 6 0-0 d6 7 Nc3 c6\par \textbf{\ldotsd6} \textbf{2.} \textbf{c4} \textbf{f5} \textbf{3.} \textbf{Nf3}
...
let suite =
  "pgn2tex tests" >::: [ "basic_pgn_to_tex" >:: test_basic_pgn_to_tex ]
